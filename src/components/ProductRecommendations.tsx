  ...
  return (
    ...
    >
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-sm text-amber-800">
        <strong>Nota:</strong> Estas son recomendaciones aproximadas basadas en
        análisis de IA. Los resultados pueden variar según la iluminación de la
        foto. Para mejores resultados, toma la foto con luz natural y consulta
        con un especialista.
      </div>
